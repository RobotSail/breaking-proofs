...
- **HALT** (exit non-zero / FAIL in output) → do NOT spawn `staleness_checker`. Skip to the next CEO review gate or finalize as error.
...
- **HALT** (exit non-zero / FAIL in output) → do NOT spawn `gate_render`. Skip to the next CEO review gate or finalize as error.
...
- **HALT** (exit non-zero / FAIL in output) → do NOT spawn `gate_ci`. Skip to the next CEO review gate or finalize as error.
...
- **HALT** (exit non-zero / FAIL in output) → do NOT spawn `health_checker`. Skip to the next CEO review gate or finalize as error.
...
Read: .factory/design-system/rules.md, .factory/reviews/builder-latest.md
...
- **HALT** (exit non-zero / FAIL in output) → do NOT spawn `consistency_tester`. Skip to the next CEO review gate or finalize as error.
